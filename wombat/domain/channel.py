...
class Layer:
    ...
    # If this layer was generated by a plugin, store the source so it can be
    # reopened and regenerated. plugin_id matches the plugin's manifest id;
    # plugin_params is the parameter set that produced these actions.
